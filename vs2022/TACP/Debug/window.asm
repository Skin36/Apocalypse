; Listing generated by Microsoft (R) Optimizing Compiler Version 19.34.31933.0 
	...
	TITLE	D:\FreeApoc\Apocalypse\vs2022\TACP\Debug\window.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File D:\FreeApoc\Apocalypse\TACP\C_Sources\window.c
...
; 292  : {
	...
	rep stosd
	mov	ecx, OFFSET __4F68F50C_window@c
...
; 294  : 	//ret_val |= destroy();
; 295  : 	m_surface = SDL_CreateRGBSurfaceWithFormatFrom(screen_buffer, surface_width, surface_height, 8, 3*surface_width, SDL_PIXELFORMAT_INDEX8);
...
; 297  : 
; 298  : 
; 299  : 	if (m_surface == NULL) {

	cmp	DWORD PTR _m_surface, 0
	jne	SHORT $LN2@screen_dat

; 300  : 		SDL_Log("Creating surface failed: %s", SDL_GetError());
...
; 301  : 		//stbi_image_free(screen_buffer);
; 302  : 		exit(1);
...
; 309  : 	}
; 310  : 	//m_must_lock_surface = SDL_MUSTLOCK(m_surface);
; 311  : 
; 312  : 	if (surface_width - offset_x < 0 || surface_height - offset_y < 0)
...
; 322  :     
; 323  : 	
; 324  : 	//SDL_RenderClear(m_renderer);
; 325  : 
; 326  : 	//SDL_LockSurface(m_surface);
; 327  : 	//SDL_UnlockSurface(m_surface);
; 328  : 	//m_texture = SDL_CreateTextureFromSurface(m_renderer, m_surface);
; 329  : 	//ret_val |= SDL_CreateTextureFromSurface(m_renderer, m_surface);
; 330  : 
; 331  : 	SDL_RenderCopy(m_renderer, m_texture, NULL, NULL);
...
; 102  : 	SDL_Color color;
; 103  : 	SDL_Palette* p = m_surface->format->palette;
...
; 108  : 	{
; 109  : 		color.r = (current_pal[n * 3] << 2 | (current_pal[n * 3] >> 4 & 0x3));
...
; 110  : 		color.g = (current_pal[n * 3 + 1] << 2 | (current_pal[n * 3 + 1] >> 4 & 0x3));
...
; 111  : 		color.b = (current_pal[n * 3 + 2] << 2 | (current_pal[n * 3 + 2] >> 4 & 0x3));
...
; 114  : 		ret_val |= SDL_SetPaletteColors(p, &color, i, 1);
...
; 115  : 		//printf ("r= %d,g= %d,b= %d\n", pal_ptr[n * 3], pal_ptr[n * 3 + 1], pal_ptr[n * 3 + 2]);
; 116  : 		//printf("r1= %d,r2= %d\n", (pal_ptr[n * 3] << 2 | (pal_ptr[n * 3] >> 4 & 0x3)), 4*pal_ptr[n * 3]);
; 117  : 		//SDL_SetPalette(result, SDL_LOGPAL, colors, 0, 256);
; 118  : 	}

	jmp	$LN2@set_palett
$LN3@set_palett:

; 119  : 	ret_val |= SDL_SetSurfacePalette(m_surface, p);
...
; 120  : 	//SDL_SaveBMP(m_surface, "12345.bmp");
; 121  : }
...
; 341  : 	SDL_DestroyRenderer(m_renderer);
...
; 342  : 	SDL_DestroyWindow(m_window);
...
_TEXT	SEGMENT
_m_texture_coord_in_surface$ = -24			; size = 16
...
; 72   : 	SDL_Rect m_texture_coord_in_surface;
; 73   : 
; 74   : 	m_texture_coord_in_surface.x = screenx;

	movzx	eax, WORD PTR _screenx
	mov	DWORD PTR _m_texture_coord_in_surface$[ebp], eax

; 75   : 	m_texture_coord_in_surface.y = screeny;

	movzx	eax, WORD PTR _screeny
	mov	DWORD PTR _m_texture_coord_in_surface$[ebp+4], eax

; 76   : 	m_texture_coord_in_surface.w = screenx - screenx_1;
...
; 77   : 	m_texture_coord_in_surface.h = screeny - screeny_1;
...
; 78   : 
; 79   : 	//printf("screenx_1= %d,screenx= %d,screeny= %d\n", screenx_1, screenx, screeny);
; 80   : 	if (screenx_1 < screenx && screeny_1 < screeny)
...
; 81   : 	{
; 82   : 		m_texture_coord_in_surface.x = screenx;

	movzx	eax, WORD PTR _screenx
	mov	DWORD PTR _m_texture_coord_in_surface$[ebp], eax

; 83   : 		m_texture_coord_in_surface.y = screeny;

	movzx	eax, WORD PTR _screeny
	mov	DWORD PTR _m_texture_coord_in_surface$[ebp+4], eax

; 84   : 		m_texture_coord_in_surface.w = screenx - screenx_1;
...
; 85   : 		m_texture_coord_in_surface.h = screeny - screeny_1;
...
; 86   : 
; 87   : 
; 88   : 	    //SDL_RenderClear(m_renderer);
; 89   : 		m_surface = SDL_CreateRGBSurfaceFrom(temp_screen_buffer, 640, 480, 8, 640, 0, 0, 0, 0);
...
; 91   : 		screen_texture = SDL_CreateTextureFromSurface(m_renderer, m_surface);
...
; 92   : 		SDL_RenderCopy(m_renderer, screen_texture, NULL, NULL);
...
; 93   : 		//SDL_RenderCopy(m_renderer, screen_texture, NULL, &m_texture_coord_in_surface);
; 94   : 		SDL_RenderPresent(m_renderer);
...
; 39   : 	m_surface = SDL_CreateRGBSurfaceFrom(temp_screen_buffer, 640, 480, 8, 640, 0, 0, 0, 0);
...
; 41   : 	screen_texture = SDL_CreateTextureFromSurface(m_renderer, m_surface);
...
; 42   : 	//SDL_SaveBMP(m_surface, "123456.bmp");
; 43   : 	
; 44   : 	
; 45   : 	//SDL_RenderClear(m_renderer);
; 46   : 	SDL_RenderCopy(m_renderer, screen_texture, NULL, NULL);
...
; 47   : 	SDL_RenderPresent(m_renderer);
...
; 49   : 	//SDL_SaveBMP(m_surface, "123456.bmp");
; 50   : 
; 51   : 	//screen_data_init((uint8_t*)isobord1_dat, 640, 480, 640, 128, 0, 400);
; 52   : 
; 53   : 	/*
; 54   : 	SDL_Event event;
; 55   : 	while (1)
...
; 58   : 		{
; 59   : 			if (event.type == SDL_MOUSEBUTTONDOWN)
; 60   : 			{
; 61   : 				break;
; 62   : 			}
; 63   : 		}
...
; 133  : 	uint8_t r1, r2, g1, g2, b1, b2;
; 134  : 	uint32_t index = 16;
...
; 148  : 
; 149  : 		current_pal[index * 3] = r2 + ((mix_index * (r1 - r2)) >> 5);
...
; 150  : 		current_pal[index * 3 + 1] = g2 + ((mix_index * (g1 - g2)) >> 5);
...
; 151  : 		current_pal[index * 3 + 2] = b2 + ((mix_index * (b1 - b2)) >> 5);
...
; 126  : 	current_pal[index * 3 + 1] = green;
...
; 127  : 	current_pal[index * 3 + 2] = blue;
...
; 168  : 	SDL_SaveBMP(m_surface, path);
...
;	COMDAT _video_init
_TEXT	SEGMENT
_monitor_height$1 = -60					; size = 4
_monitor_width$2 = -48					; size = 4
_DM$3 = -36						; size = 20
_ret_val$ = -8						; size = 4
...
; 178  : 	//int imgFlags = IMG_INIT_PNG;
; 179  : 	//IMG_Init(imgFlags);
; 180  : 
...
; 186  : 
; 187  : 	SDL_DisplayMode DM;
; 188  : 		if (SDL_GetCurrentDisplayMode(0, &DM))
...
; 195  :     }
; 196  : 	
; 197  : 	    m_window = SDL_CreateWindow("Apocalypse",
...
; 198  : 		SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 480, 0);
; 199  : 
; 200  : 	if (!m_window)
...
; 205  : 	}
; 206  : 
; 207  : 	m_renderer = SDL_CreateRenderer(m_window, -1, 0);
...
; 209  : 	//PCX_Load("UFODATA\\TITLES.PCX");
; 210  : 	//SDL_RenderPresent(m_renderer);
; 211  : 
; 212  : 
; 213  : 	//SDL_Event event;
; 214  : 	
...
; 218  : 		//{ 
; 219  : 		//if (event.type == SDL_MOUSEBUTTONDOWN)
; 220  : 		//{
; 221  : 			//free_win();
; 222  : 			//SDL_Quit();
; 223  : 			//exit(0);
...
; 226  : 	//}
; 227  : 	
; 228  : 	//for (; events.type != SDL_QUIT && events.type != SDL_KEYDOWN; SDL_PollEvent(&events));
; 229  : 
; 230  : 	//SDL_DestroyWindow(m_window);
; 231  : 	//SDL_Quit();
; 232  : 
; 233  :     return ret_val;
