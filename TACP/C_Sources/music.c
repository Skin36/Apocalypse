...
int smooth_decrease_music_vol()
{
    uint16_t music_volum_tmp = music_volum;

    while (music_volum_tmp > 100)
    {
        if (main_volum_flg && music_volum_flg)
        {
            music_volum = 100 * music_volum_tmp / 85;
            set_volume();
        }
        music_volum_tmp -= 100;
    }
